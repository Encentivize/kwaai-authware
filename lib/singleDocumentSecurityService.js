...
var multiTenantTools=function(options,mainCallback){
    ...
    async.series([
        function(callback){
            kwaaiCrudware=require('kwaai-crudware').crudWare(connectionString,connectionOptions,callback);
        },
        function(callback){
            kwaaiCrud=require("kwaai-crud").crudTools(connectionString,connectionOptions,callback);
        }
    ]
...
module.exports= function(options,callback){
    return new multiTenantTools(options,callback);
}
