...
var tokenAccessService=function(options,mainCallback){
    ...
    var kwaaiCrud=require("kwaai-crud").crudTools(connectionString,connectionOptions,mainCallback);
...
module.exports= function(options,callback){
    return new tokenAccessService(options,callback);
}
